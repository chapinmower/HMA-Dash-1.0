...
if __name__ == "__main__":
    ...
    # Process all PDFs in the HMA reports directory
    pdf_directory = "/Volumes/Crispy Memes LLC/HMA_Marketing_Dashboard/HMA-Dash-1.0/reports/Data Reports hmadash"
    
    print(f"Processing PDFs from: {pdf_directory}")
    results = extractor.process_all_pdfs(pdf_directory)
    
    print(f"\nPDF extraction complete! Processed {len(results)} reports.")
    print(f"JSON files saved to: {extractor.output_dir}")
